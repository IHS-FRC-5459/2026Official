...
public class AutoShootAlign extends Command {
  ...
  public void execute() {
    ...
    isDone = joystickDriveAtAngleCustom(s_drive, xSupplier, ySupplier, omegaSupplier);
  }
  ...
  public void end(boolean interrupted) {
    ...
    s_drive.stopWithX();
    Logger.recordOutput(loggingPrefix + "ended", true);
  }
